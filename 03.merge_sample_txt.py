...
f2 = '/home/projects/IrishGWAS/SCZ_CC/Post_all_QC/HRC_version_r.1.1/genos/HRC.r.1.1.chr22.samples'
...
final.to_csv("Final_SCZ_CC.fam", index=False, header=True, sep=' ')
